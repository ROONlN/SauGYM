    ...
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AppointmentId,AppointmentDate,ServiceId,TrainerId")] Appointment appointment)
        {
            ...
            if (selectedTrainer != null && selectedService != null)
            {
                ...
                {
                    ModelState.AddModelError("", $"⚠️ Uyarı: {selectedTrainer.FullName} isimli hoca '{selectedTrainer.Specialization}' alanında uzmandır. '{selectedService.ServiceName}' dersi için uygun olmayabilir.");
                }
                ...
                foreach (var existing in existingAppointments)
                {
                    ...
                    {
                        ModelState.AddModelError("", $"Seçtiğiniz antrenör bu saat aralığında ({existingStart:HH:mm} - {existingEnd:HH:mm}) doludur.");
                        break;
                    }
                }
            }
